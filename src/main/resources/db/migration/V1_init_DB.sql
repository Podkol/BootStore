...
--     alter table if exists orders_details drop constraint if exists FKgvp1k7a3ubdboj3yhnawd5m1p;
...
--     create table orders (id int8 not null, address varchar(255), created timestamp, status varchar(255), sum numeric(19, 2), update timestamp, user_id int8, primary key (id));
...
--     create table users (id int8 not null, archive boolean not null, email varchar(255), name varchar(255), password varchar(255), role_user varchar(255), bucket_id int8, primary key (id));
